...
update_option( 'tfp_page_nettoyage-professionnel', array(
		...
		'sections' => array(
			array(
				...
				'fond' => '',
				'padding_haut' => '0px',
				'padding_bas' => 'clamp(36px, 4vw, 56px)',
				'largeur_texte' => 0,
				'largeur_conteneur' => 0,
				'colonnes' => 1,
				'cartes' => '',
					...
					array(
						...
						'sequence' => array(
							array(
								...
								'rayon' => '12px',
								'filet' => '0px',
								'filet_couleur' => 'rgb(255, 255, 255)',
								'padding' => '10px 16px',
								'theme' => 'sombre',
								'titre_taille' => '22px',
								'titre_interligne' => '35.64px',
								'desc_taille' => '12.5px',
								'desc_interligne' => '14.75px',
								'desc_marge' => '0px',
								'variante' => 'texte',
								'items' => array(
									array(
										'titre' => '27 € HT/h',
										'titre_tag' => '',
										'description' => 'tarif unique en région',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '22px',
										'titre_interligne' => '35.64px',
			...
			array(
				'index' => 3,
				'fond' => 'blanc',
				'padding_haut' => 'clamp(40px, 5vw, 72px)',
				'padding_bas' => 'clamp(40px, 5vw, 72px)',
				'largeur_texte' => 740,
				'largeur_conteneur' => 820,
				'colonnes' => 1,
				'cartes' => '',
				'liste_grille' => array(
					'colonnes' => 1,
			...
			array(
				'index' => 4,
				'fond' => '',
				'padding_haut' => 'clamp(44px, 6vw, 84px)',
				'padding_bas' => 'clamp(44px, 6vw, 84px)',
				'largeur_texte' => 562,
				'largeur_conteneur' => 1260,
				'colonnes' => 2,
				'cartes' => '',
				'liste_grille' => array(
					'colonnes' => 1,
					...
					array(
						...
						'sequence' => array(
							...
							array(
								...
								'rayon' => '0px',
								'filet' => '2px',
								'filet_couleur' => 'rgb(23, 74, 129)',
								'padding' => '16px 0px 0px',
								'theme' => 'sombre',
								'titre_taille' => '18px',
								'titre_interligne' => '18.72px',
								'desc_taille' => '15.5px',
								'desc_interligne' => '25.575px',
								'desc_marge' => '9px',
								'variante' => 'texte',
								'items' => array(
									array(
										...
										'titre_tag' => 'h3',
										'description' => 'Dépoussiérage des plans de travail dégagés, du mobilier et des surfaces de contact. Les écrans et claviers font l\'objet d\'un dépoussiérage prudent selon les consignes et le matériel autorisé. Les documents et effets personnels ne sont jamais déplacés : la surface est reprise autour d\'eux.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '18px',
										'titre_interligne' => '18.72px',
									...
									array(
										...
										'titre_tag' => 'h3',
										'description' => 'Aspiration et lavage selon la nature du revêtement : moquette, vinyle, carrelage, parquet, béton ciré, résine. Les circulations et les entrées se salissent trois à quatre fois plus vite que le reste et justifient souvent une fréquence propre, plus élevée que celle des bureaux eux-mêmes.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '18px',
										'titre_interligne' => '18.72px',
									...
									array(
										'titre' => 'Sanitaires',
										'titre_tag' => 'h3',
										'description' => 'Nettoyage et désinfection des cuvettes, lavabos, robinetteries, miroirs, poignées et sols, avec réapprovisionnement du papier, du savon et des sacs lorsque vous fournissez ces consommables. Tout dysfonctionnement est signalé dans le cahier de liaison plutôt que laissé à la découverte d\'un visiteur.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '18px',
										'titre_interligne' => '18.72px',
									...
									array(
										...
										'titre_tag' => 'h3',
										'description' => 'Plan de travail, évier, tables, extérieur des appareils, sol et poubelle. L\'intérieur du réfrigérateur, le dégivrage et le nettoyage intérieur du four sont possibles mais planifiés séparément : ils supposent que la cuisine soit vidée et demandent un temps que le passage courant n\'absorbe pas.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '18px',
										'titre_interligne' => '18.72px',
									...
									array(
										...
										'titre_tag' => 'h3',
										'description' => 'Comptoir, assises, tables basses, tapis de propreté, vitrage de la porte d\'entrée, surfaces de contact courantes. C\'est le premier espace vu par un visiteur, et souvent celui sur lequel une négligence se remarque le plus vite : il est traité à chaque passage.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '18px',
										'titre_interligne' => '18.72px',
									...
									array(
										...
										'titre_tag' => 'h3',
										'description' => 'Vitres intérieures, cloisons vitrées, portes et vitrophanies accessibles sans équipement spécialisé, à une fréquence plus espacée. Tout ce qui exige une nacelle, une perche télescopique ou un échafaudage est exclu de la prestation courante et relève d\'un prestataire équipé pour le travail en hauteur.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '18px',
										'titre_interligne' => '18.72px',
			...
			array(
				'index' => 18,
				'fond' => 'primary',
				'padding_haut' => 'clamp(48px, 6vw, 84px)',
				'padding_bas' => 'clamp(48px, 6vw, 84px)',
				'largeur_texte' => 0,
				'largeur_conteneur' => 1040,
				'colonnes' => 1,
				'cartes' => '',
				'liste_grille' => array(
					'colonnes' => 1,
...
update_option( 'tfp_page_prestations', array(
		...
		'sections' => array(
			array(
				...
				'fond' => '',
				'padding_haut' => '0px',
				'padding_bas' => 'clamp(20px, 3vw, 32px)',
				'largeur_texte' => 243,
				'largeur_conteneur' => 1260,
				'colonnes' => 1,
				'cartes' => '',
			...
			array(
				'index' => 3,
				'fond' => '',
				'padding_haut' => 'clamp(24px, 3vw, 36px)',
				'padding_bas' => 'clamp(8px, 1vw, 12px)',
				'largeur_texte' => 616,
				'largeur_conteneur' => 1260,
				'colonnes' => 2,
				'cartes' => '',
			...
			array(
				'index' => 4,
				'fond' => '',
				'padding_haut' => 'clamp(20px, 3vw, 32px)',
				'padding_bas' => 'clamp(48px, 6vw, 88px)',
				'largeur_texte' => 0,
				'largeur_conteneur' => 1260,
				'colonnes' => 1,
				'cartes' => '',
							...
							array(
								...
								'items' => array(
									array(
										'titre' => 'Nettoyage de bureaux',
										'titre_tag' => '',
										'description' => 'Un entretien régulier et discret de vos espaces de travail, confié autant que possible à un intervenant habituel, pour des bureaux toujours prêts à recevoir vos équipes et vos visiteurs.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '23px',
										'titre_interligne' => '37.26px',
									...
									array(
										'titre' => 'Nettoyage de commerces',
										'titre_tag' => '',
										'description' => 'Une surface de vente impeccable à l\'ouverture : sols, vitrines et sanitaires clients entretenus avant l\'arrivée de vos premiers visiteurs.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '23px',
										'titre_interligne' => '37.26px',
									...
									array(
										'titre' => 'Cabinets & professions libérales',
										'titre_tag' => '',
										'description' => 'L\'entretien courant des cabinets médicaux, paramédicaux, juridiques et de conseil : accueil, salle d\'attente, bureaux, sanitaires et sols, en dehors des heures de consultation et dans le respect de la confidentialité.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '23px',
										'titre_interligne' => '37.26px',
									...
									array(
										'titre' => 'Copropriétés & parties communes',
										'titre_tag' => '',
										'description' => 'L\'entretien régulier des halls, cages d\'escalier, ascenseurs et locaux communs, pour des résidences et immeubles tertiaires soignés au quotidien.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '23px',
										'titre_interligne' => '37.26px',
									...
									array(
										'titre' => 'Locations meublées & hébergements',
										'titre_tag' => '',
										'description' => 'La remise en état de vos meublés et hébergements professionnels entre deux occupants, avec un contrôle visuel et un signalement des anomalies selon l\'organisation définie avec le client.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '23px',
										'titre_interligne' => '37.26px',
									...
									array(
										'titre' => 'Nettoyage ponctuel & remise en état',
										'titre_tag' => '',
										'description' => 'Une intervention ponctuelle pour une remise en état après travaux, un grand nettoyage saisonnier ou une fin de bail, au même tarif horaire que nos prestations régulières.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '23px',
										'titre_interligne' => '37.26px',
			...
			array(
				'index' => 5,
				'fond' => 'primary',
				'padding_haut' => 'clamp(44px, 6vw, 72px)',
				'padding_bas' => 'clamp(44px, 6vw, 72px)',
				'largeur_texte' => 520,
				'largeur_conteneur' => 1040,
				'colonnes' => 1,
				'cartes' => '',
...
update_option( 'tfp_page_zones-intervention', array(
		...
		'sections' => array(
			array(
				...
				'fond' => '',
				'padding_haut' => '0px',
				'padding_bas' => 'clamp(26px, 3vw, 40px)',
				'largeur_texte' => 0,
				'largeur_conteneur' => 0,
				'colonnes' => 1,
				'cartes' => '',
			...
			array(
				'index' => 3,
				'fond' => 'blanc',
				'padding_haut' => 'clamp(30px, 4vw, 50px)',
				'padding_bas' => 'clamp(30px, 4vw, 50px)',
				'largeur_texte' => 760,
				'largeur_conteneur' => 860,
				'colonnes' => 1,
				'cartes' => '',
				'liste_grille' => array(
					'colonnes' => 1,
			...
			array(
				'index' => 4,
				'fond' => '',
				'padding_haut' => 'clamp(34px, 4vw, 58px)',
				'padding_bas' => 'clamp(34px, 4vw, 58px)',
				'largeur_texte' => 754,
				'largeur_conteneur' => 900,
				'colonnes' => 1,
				'cartes' => array(
					'padding' => '32px',
					'rayon' => '18px',
					...
					'majoritaire' => true,
					'parTitre' => array(
						'Une couverture régionale organisée depuis Saint-Apollinaire' => array(
							'padding' => 'clamp(22px, 3vw, 32px)',
							'rayon' => '18px',
							'fond' => 'rgb(255, 255, 255)',
							'marge_bas' => '14px',
						),
						'Comment nous organisons les déplacements' => array(
							'padding' => 'clamp(22px, 3vw, 32px)',
							'rayon' => '18px',
							'fond' => 'rgb(255, 255, 255)',
							'marge_bas' => '14px',
						),
						'Ce qui change selon votre adresse' => array(
							'padding' => 'clamp(22px, 3vw, 32px)',
							'rayon' => '18px',
							'fond' => 'rgb(255, 255, 255)',
							'marge_bas' => '14px',
			...
			array(
				...
				'fond' => '',
				'padding_haut' => '0px',
				'padding_bas' => 'clamp(34px, 4vw, 54px)',
				'largeur_texte' => 0,
				'largeur_conteneur' => 1260,
				'colonnes' => 1,
				'cartes' => '',
							...
							array(
								...
								'items' => array(
									array(
										...
										'titre_graisse' => 600,
										'desc_graisse' => 400,
										'en_ligne_justify' => 'space-between',
										'badge' => '',
										'provisoire' => false,
										'surtitre' => '',
										'icone' => '',
			...
			array(
				...
				'fond' => '',
				'padding_haut' => '0px',
				'padding_bas' => 'clamp(38px, 5vw, 64px)',
				'largeur_texte' => 754,
				'largeur_conteneur' => 900,
				'colonnes' => 1,
				'cartes' => array(
					...
					'majoritaire' => true,
					'parTitre' => array(
						'Départements, villes et communes : comment lire ces pages' => array(
							'padding' => 'clamp(22px, 3vw, 32px)',
							'rayon' => '18px',
							'fond' => 'rgb(255, 255, 255)',
							'marge_bas' => '14px',
						),
						'Les espaces que nous traitons — et ceux que nous ne traitons pas' => array(
							'padding' => 'clamp(22px, 3vw, 32px)',
							'rayon' => '18px',
							'fond' => 'rgb(255, 255, 255)',
							'marge_bas' => '14px',
						),
						'Votre commune n\'apparaît pas encore ?' => array(
							'padding' => 'clamp(22px, 3vw, 32px)',
							'rayon' => '18px',
							'fond' => 'rgb(255, 255, 255)',
							'marge_bas' => '14px',
			...
			array(
				...
				'fond' => '',
				'padding_haut' => '0px',
				'padding_bas' => 'clamp(40px, 5vw, 68px)',
				'largeur_texte' => 0,
				'largeur_conteneur' => 1260,
				'colonnes' => 1,
				'cartes' => '',
			...
			array(
				'index' => 11,
				'fond' => 'turquoise',
				'padding_haut' => 'clamp(38px, 5vw, 68px)',
				'padding_bas' => 'clamp(38px, 5vw, 68px)',
				'largeur_texte' => 740,
				'largeur_conteneur' => 860,
				'colonnes' => 1,
				'cartes' => '',
			...
			array(
				'index' => 12,
				'fond' => 'primary',
				'padding_haut' => 'clamp(44px, 6vw, 76px)',
				'padding_bas' => 'clamp(44px, 6vw, 76px)',
				'largeur_texte' => 540,
				'largeur_conteneur' => 1040,
				'colonnes' => 1,
				'cartes' => '',
		...
		'sections' => array(
			...
			array(
				...
				'cartes' => array(
					...
					'majoritaire' => true,
					'parTitre' => array(
						'Notre implantation réelle : Saint-Apollinaire, près de Dijon' => array(
							'padding' => 'clamp(22px, 3vw, 32px)',
							'rayon' => '18px',
							'fond' => 'rgb(255, 255, 255)',
							'marge_bas' => '14px',
						),
						'Le territoire que nous couvrons — et celui que nous ne couvrons pas' => array(
							'padding' => 'clamp(22px, 3vw, 32px)',
							'rayon' => '18px',
							'fond' => 'rgb(255, 255, 255)',
							'marge_bas' => '14px',
						),
						'Les professionnels que nous accompagnons' => array(
							'padding' => 'clamp(22px, 3vw, 32px)',
							'rayon' => '18px',
							'fond' => 'rgb(255, 255, 255)',
							'marge_bas' => '14px',
						),
						'Les types de locaux les plus fréquents en région' => array(
							'padding' => 'clamp(22px, 3vw, 32px)',
							'rayon' => '18px',
							'fond' => 'rgb(255, 255, 255)',
							'marge_bas' => '14px',
						),
						'Notre organisation à l\'échelle régionale' => array(
							'padding' => 'clamp(22px, 3vw, 32px)',
							'rayon' => '18px',
							'fond' => 'rgb(255, 255, 255)',
							'marge_bas' => '14px',
			...
			array(
				'index' => 6,
				'fond' => 'blanc',
				'padding_haut' => 'clamp(38px, 5vw, 64px)',
				'padding_bas' => 'clamp(38px, 5vw, 64px)',
				'largeur_texte' => 660,
				'largeur_conteneur' => 1260,
				'colonnes' => 1,
					...
					array(
						...
						'sequence' => array(
							...
							array(
								...
								'rayon' => '16px',
								'filet' => '1px',
								'filet_couleur' => 'rgb(184, 228, 228)',
								'padding' => '24px',
								'theme' => 'clair',
								'titre_taille' => '32px',
								'titre_interligne' => '51.84px',
								'desc_taille' => '14px',
								'desc_interligne' => '21.7px',
								'desc_marge' => '0px',
								'variante' => 'texte',
								'items' => array(
									array(
									...
									array(
										...
										'carte_rayon' => '16px',
										'carte_gap' => '',
										'citation' => 'Nous avions besoin d\'un prestataire capable de suivre trois sites dans deux départements sans multiplier les interlocuteurs. Le planning est tenu et les consignes circulent bien entre les passages.',
										'auteur' => 'Sophie M. · Cabinet comptable · Côte-d\'Or',
										'meta' => '',
										'etoiles' => '★★★★★',
										'source' => '',
										'citation_geo' => array(
			...
			array(
				...
				'cartes' => array(
					...
					'majoritaire' => true,
					'parTitre' => array(
						'Sélection des intervenants et suivi' => array(
							'padding' => 'clamp(22px, 3vw, 32px)',
							'rayon' => '18px',
							'fond' => 'rgb(255, 255, 255)',
							'marge_bas' => '14px',
						),
						'Entretien régulier ou intervention ponctuelle' => array(
							'padding' => 'clamp(22px, 3vw, 32px)',
							'rayon' => '18px',
							'fond' => 'rgb(255, 255, 255)',
							'marge_bas' => '14px',
						),
						'Ce que nous ne faisons pas' => array(
							'padding' => 'clamp(22px, 3vw, 32px)',
							'rayon' => '18px',
							'fond' => 'rgb(255, 255, 255)',
							'marge_bas' => '14px',
						),
						'Comment démarre une collaboration' => array(
							'padding' => 'clamp(22px, 3vw, 32px)',
							'rayon' => '18px',
							'fond' => 'rgb(255, 255, 255)',
							'marge_bas' => '14px',
				...
				'blocs' => array(
					array(
						...
						'sequence' => array(
							...
							array(
								'type' => 'link',
								'texte' => '☎ Échanger avec Audrey · 06 36 17 63 39',
								'route' => 'tel:+33636176339',
								'archetype' => 'secondaire',
								'rangee' => 'r3',
								'pad_v' => '15px',
...
update_option( 'tfp_page_pourquoi-nous', array(
		...
		'sections' => array(
			array(
				'index' => 2,
				'fond' => 'blanc',
				'padding_haut' => 'clamp(36px, 4vw, 64px)',
				'padding_bas' => 'clamp(36px, 4vw, 64px)',
				'largeur_texte' => 375,
				'largeur_conteneur' => 1260,
				'colonnes' => 1,
				'cartes' => '',
					...
					array(
						...
						'sequence' => array(
							array(
								...
								'items' => array(
									array(
										'titre' => 'Directement joignable',
										'titre_tag' => '',
										'description' => 'Audrey est votre interlocutrice identifiée du premier contact au suivi dans la durée. Elle connaît votre dossier, vos consignes et l\'historique de vos échanges — vous ne répétez jamais votre situation à un nouvel interlocuteur anonyme.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '20px',
										'titre_interligne' => '32.4px',
									...
									array(
										'titre' => 'Intervenants sélectionnés',
										'titre_tag' => '',
										'description' => 'Nous choisissons avec soin les personnes qui interviennent dans vos locaux, en particulier leur fiabilité et leur sérieux, et recherchons un intervenant habituel qui connaît vos habitudes, continuité privilégiée autant que possible sans être garantie de façon absolue.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '20px',
										'titre_interligne' => '32.4px',
									...
									array(
										'titre' => 'Suivi réel',
										'titre_tag' => '',
										'description' => 'Un cahier de liaison reste sur place pour tracer chaque passage. Le cahier des charges est ajusté dans le temps si vos besoins évoluent, et nous recherchons activement une solution en cas d\'absence de l\'intervenant.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '20px',
										'titre_interligne' => '32.4px',
									...
									array(
										...
										'titre_tag' => '',
										'description' => '27 € HT/h affiché avant même le devis, frais de gestion et de mise en place annoncés à l\'avance, exemples de budgets chiffrés. Vous savez ce que vous payez avant de nous contacter.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '20px',
										'titre_interligne' => '32.4px',
									...
									array(
										'titre' => 'Gestion prise en charge',
										'titre_tag' => '',
										'description' => 'Planning, administratif et coordination gérés par nos soins. Vous gardez un seul contact.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '20px',
										'titre_interligne' => '32.4px',
									...
									array(
										...
										'titre_tag' => '',
										'description' => 'Basée à Saint-Apollinaire, une couverture réelle sur toute la BFC, sans agences fictives.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '20px',
										'titre_interligne' => '32.4px',
			...
			array(
				'index' => 4,
				'fond' => 'blanc',
				'padding_haut' => 'clamp(44px, 6vw, 80px)',
				'padding_bas' => 'clamp(44px, 6vw, 80px)',
				'largeur_texte' => 371,
				'largeur_conteneur' => 1260,
				'colonnes' => 3,
				'cartes' => '',
							...
							array(
								...
								'items' => array(
									...
									array(
										...
										'titre_tag' => 'h3',
										'description' => 'Audrey établit le devis, rédige le cahier des charges avec vous, choisit l\'intervenant, transmet les consignes, suit le cahier de liaison et gère les ajustements. Ce n\'est pas un rôle commercial suivi d\'un transfert vers un service anonyme : c\'est la même personne du premier appel au suivi dans la durée, joignable directement, sans standard ni ticket.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '18.5px',
										'titre_interligne' => '19.24px',
									...
									array(
										...
										'titre_tag' => 'h3',
										'description' => 'Une facture mensuelle unique, un devis écrit avant toute intervention, des tarifs annoncés à l\'avance et aucune modification appliquée sans votre accord écrit. Les frais annexes — gestion mensuelle, mise en place, majoration des créneaux particuliers, indemnités kilométriques — sont détaillés sur la page Tarifs et repris sur le devis, jamais découverts sur une facture.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '18.5px',
										'titre_interligne' => '19.24px',
									...
									array(
										...
										'titre_tag' => 'h3',
										'description' => 'Un cahier de liaison reste sur place et trace chaque passage : ce qui a été fait, ce qui n\'a pas pu l\'être et pourquoi, les remarques et les consommables à renouveler. C\'est un outil simple, mais c\'est la seule façon honnête de savoir ce qui se passe réellement dans vos locaux quand vous n\'êtes pas là.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '18.5px',
										'titre_interligne' => '19.24px',
			...
			array(
				'index' => 6,
				'fond' => 'blanc',
				'padding_haut' => 'clamp(36px, 4.5vw, 64px)',
				'padding_bas' => 'clamp(36px, 4.5vw, 64px)',
				'largeur_texte' => 680,
				'largeur_conteneur' => 1260,
				'colonnes' => 1,
				'cartes' => '',
							...
							array(
								...
								'items' => array(
									array(
										...
										'titre_tag' => '',
										'description' => 'Vous nous décrivez vos locaux (surface, type d\'activité, effectif présent), vos besoins et vos contraintes d\'horaires, par téléphone ou via le formulaire de devis. Cet échange initial, généralement bref, nous permet déjà d\'orienter la prestation adaptée parmi nos six formules.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '19px',
										'titre_interligne' => '30.78px',
									...
									array(
										...
										'titre_tag' => '',
										'description' => 'Nous étudions le volume d\'heures nécessaire selon la surface, la fréquence souhaitée et le niveau d\'exigence de vos locaux (standard ou renforcé pour les espaces recevant du public). C\'est cette étape qui détermine un devis réaliste, plutôt qu\'une estimation automatique.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '19px',
										'titre_interligne' => '30.78px',
									...
									array(
										...
										'titre_tag' => '',
										'description' => 'Vous recevez une proposition claire et chiffrée, basée sur 27 € HT/h, détaillant le volume d\'heures estimé, les frais éventuels de gestion et de mise en place, et l\'organisation envisagée. Sans engagement de votre part.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '19px',
										'titre_interligne' => '30.78px',
...
update_option( 'tfp_page_avis-clients', array(
		...
		'sections' => array(
					...
					array(
						...
						'sequence' => array(
							array(
								...
								'rayon' => '0px',
								'filet' => '0px',
								'filet_couleur' => 'rgb(24, 35, 45)',
								'padding' => '0px',
								'theme' => 'sombre',
								'titre_taille' => '56px',
								'titre_interligne' => '56px',
								'desc_taille' => '20px',
								'desc_interligne' => '32.4px',
								'desc_marge' => '0px',
								'variante' => 'texte',
								'items' => array(
									array(
			...
			array(
				'index' => 3,
				'fond' => '',
				'padding_haut' => 'clamp(10px, 2vw, 20px)',
				'padding_bas' => 'clamp(28px, 3vw, 40px)',
				'largeur_texte' => 340,
				'largeur_conteneur' => 1260,
				'colonnes' => 1,
				'cartes' => '',
							...
							array(
								...
								'items' => array(
									array(
										...
										'carte_rayon' => '0px',
										'carte_gap' => '',
										'citation' => 'Nous avons comparé une embauche et un prestataire. Ce qui a tranché, c\'est le cahier des charges écrit noir sur blanc et le fait de savoir dès le départ ce qui n\'était pas inclus.',
										'auteur' => 'Marc V. · Directeur administratif · Chalon-sur-Saône',
										'meta' => '',
										'etoiles' => '★★★★★',
										'source' => '',
										'citation_geo' => array(
									...
									array(
										'archetype' => 'pile',
										'pile_fond' => 'rgb(23, 74, 129)',
										'pile_rayon' => '12px',
										'pile_padding' => '14px 16px',
										'pile_gap' => '10px',
										'tuiles' => array(
											array(
												'etoiles' => '★★★★★',
												'etoiles_geo' => array(
													'taille' => '12px',
													'interligne' => 1.62,
													'couleur' => 'rgb(234, 179, 8)',
												),
												'texte' => 'Devis clair reçu le lendemain, sans surprise. Le respect des consignes de confidentialité dans le cabinet a tout de suite été un point fort.',
												'texte_geo' => array(
													'taille' => '13.5px',
													'interligne' => 1.5,
													'couleur' => 'rgb(221, 244, 243)',
												),
											),
											array(
												'etoiles' => '★★★★★',
												...
												'texte' => 'Nettoyage de la boutique avant l\'ouverture, vitrines nickel. Les horaires ont été adaptés à nos jours de marché sans discuter.',
												'texte_geo' => array(
													'taille' => '13.5px',
													'interligne' => 1.5,
													'couleur' => 'rgb(221, 244, 243)',
			...
			array(
				'index' => 4,
				'fond' => '',
				'padding_haut' => 'clamp(8px, 1vw, 16px)',
				'padding_bas' => 'clamp(48px, 6vw, 88px)',
				'largeur_texte' => 0,
				'largeur_conteneur' => 1260,
				'colonnes' => 1,
							...
							array(
								...
								'items' => array(
									array(
										...
										'carte_rayon' => '16px',
										'carte_gap' => '14px',
										'citation' => 'Même intervenante chaque semaine dans nos bureaux, un cahier de liaison sérieux et Audrey qui répond dans l\'heure. On a enfin arrêté de gérer ça en interne.',
										'auteur' => 'Camille R.',
										'meta' => 'Dirigeante de PME · Bureaux, Dijon · mars 2026',
										'etoiles' => '★★★★★',
										'source' => 'Google',
										'citation_geo' => array(
											'taille' => '16px',
									...
									array(
										...
										'carte_rayon' => '16px',
										'carte_gap' => '14px',
										'citation' => 'Devis clair reçu le lendemain, sans surprise. Le respect des consignes de confidentialité dans le cabinet a tout de suite été un point fort.',
										'auteur' => 'Thomas L.',
										'meta' => 'Responsable de cabinet · Cabinet médical, Besançon · février 2026',
										'etoiles' => '★★★★★',
										'source' => 'Google',
										'citation_geo' => array(
											'taille' => '16px',
									...
									array(
										...
										'carte_rayon' => '16px',
										'carte_gap' => '14px',
										'citation' => 'Nettoyage de la boutique avant l\'ouverture, vitrines nickel. Les horaires ont été adaptés à nos jours de marché sans discuter.',
										'auteur' => 'Sarah B.',
										'meta' => 'Commerçante · Boutique, Dole · février 2026',
										'etoiles' => '★★★★★',
										'source' => 'Google',
										'citation_geo' => array(
											'taille' => '16px',
									...
									array(
										...
										'carte_rayon' => '16px',
										'carte_gap' => '14px',
										'citation' => 'Pour nos copropriétés, le suivi est réel : halls et cages d\'escalier constants, et un remplacement trouvé rapidement pendant les congés.',
										'auteur' => 'Nadia M.',
										'meta' => 'Gestionnaire de copropriété · Parties communes, Chalon-sur-Saône · janvier 2026',
										'etoiles' => '★★★★★',
										'source' => 'Google',
										'citation_geo' => array(
											'taille' => '16px',
									...
									array(
										...
										'carte_rayon' => '16px',
										'carte_gap' => '14px',
										'citation' => 'Remises en état entre deux locataires impeccables, avec un contrôle avant chaque arrivée. Réactivité au rendez-vous pour la location meublée.',
										'auteur' => 'Julien P.',
										'meta' => 'Gestionnaire de meublés · Location meublée, Auxerre · janvier 2026',
										'etoiles' => '★★★★★',
										'source' => 'Google',
										'citation_geo' => array(
											'taille' => '16px',
									...
									array(
										...
										'carte_rayon' => '16px',
										'carte_gap' => '14px',
										'citation' => 'Remise en état ponctuelle après travaux, devis précis et résultat au rendez-vous dans les délais annoncés. Interlocuteur unique appréciable.',
										'auteur' => 'Olivier D.',
										'meta' => 'Gérant · Remise en état, Besançon · décembre 2025',
										'etoiles' => '★★★★★',
										'source' => 'Google',
										'citation_geo' => array(
											'taille' => '16px',
			...
			array(
				...
				'fond' => '',
				'padding_haut' => '0px',
				'padding_bas' => 'clamp(48px, 6vw, 80px)',
				'largeur_texte' => 680,
				'largeur_conteneur' => 1260,
				'colonnes' => 1,
				'cartes' => '',
							...
							array(
								...
								'items' => array(
									array(
										'titre' => 'Proximité',
										'titre_tag' => '',
										'description' => 'Basée à Saint-Apollinaire, nous restons une entreprise régionale, pas une plateforme nationale. Audrey reste joignable directement, sans standard ni ticket à ouvrir.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '18px',
										'titre_interligne' => '29.16px',
									...
									array(
										'titre' => 'Rigueur',
										'titre_tag' => '',
										'description' => 'Un cahier des charges défini avant chaque prestation, un cahier de liaison à chaque passage, et une organisation identique pour tous nos clients, quel que soit le département.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '18px',
										'titre_interligne' => '29.16px',
									...
									array(
										'titre' => 'Transparence',
										'titre_tag' => '',
										'description' => '27 € HT/h affiché avant le devis, frais annoncés à l\'avance, exemples de budgets chiffrés. Nous nous interdisons les formulations vagues du type « satisfaction garantie ».',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '18px',
										'titre_interligne' => '29.16px',
									...
									array(
										'titre' => 'Filiation Top-Famille',
										'titre_tag' => '',
										'description' => 'Top-Famille Pro reprend la logique de service qui a fait ses preuves auprès des particuliers avec Top-Famille, adaptée aux exigences propres aux professionnels.',
										'liste' => array(),
										'lignes' => array(),
										'titre_taille' => '18px',
										'titre_interligne' => '29.16px',
				...
				'blocs' => array(
					...
					array(
						...
						'sequence' => array(
							...
							array(
								'type' => 'link',
								'texte' => '☎ Parler de mes locaux avec Audrey',
								'route' => 'tel:+33636176339',
								'archetype' => 'primaire',
								'rangee' => 'r1',
								'pad_v' => '14px',
				...
				'blocs' => array(
					array(
						...
						'sequence' => array(
							...
							array(
								'type' => 'link',
								'texte' => 'Envoyer ma candidature',
								'route' => 'mailto:audrey.b@top-famille.fr',
								'archetype' => 'primaire',
								'rangee' => 'r2',
								'pad_v' => '15px',
								'pad_h' => '26px',
