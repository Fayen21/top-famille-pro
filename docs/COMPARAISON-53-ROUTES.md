...
|---|---|---|---|---|---|---|---|---|---|
| `#/` | `/` | 13 → 13 | 7825 → 7852 (100 %) | 1058 → 1129 (107 %) | 11 → 13 | 15 → 31 | 11 → 11 | non | — |
| `#/nos-tarifs` | `/tarifs/` | 13 → 13 | 5852 → 5873 (100 %) | 951 → 962 (101 %) | 10 → 16 | 24 → 51 | 2 → 3 | non | — |
| `#/pourquoi-top-famille-pro` | `/pourquoi-nous/` | 8 → 8 | 4047 → 4212 (104 %) | 1038 → 1058 (102 %) | 12 → 14 | 15 → 28 | 2 → 3 | non | — |
| `#/avis-clients` | `/avis-clients/` | 7 → 7 | 2938 → 3351 (114 %) | 613 → 644 (105 %) | 3 → 5 | 15 → 28 | 2 → 3 | non | — |
| `#/conseils` | `/conseils/` | 7 → 7 | 2834 → 3271 (115 %) | 465 → 472 (102 %) | 3 → 12 | 15 → 32 | 5 → 6 | non | — |
| `#/demande-de-devis` | `/demande-de-devis/` | 1 → 4 | 1947 → 2647 (136 %) | 366 → 375 (102 %) | 1 → 4 | 15 → 28 | 3 → 3 | non | — |
| `#/nos-prestations` | `/prestations/` | 6 → 6 | 3510 → 3564 (102 %) | 808 → 780 (97 %) | 5 → 7 | 15 → 28 | 8 → 3 | non | — |
| `#/nettoyage-professionnel` | `/nettoyage-professionnel/` | 19 → 19 | 11192 → 10621 (95 %) | 2560 → 2579 (101 %) | 44 → 46 | 29 → 42 | 10 → 3 | non | — |
| `#/service/bureaux` | `/prestations/bureaux/` | 14 → 14 | 7745 → 7656 (99 %) | 2074 → 2079 (100 %) | 30 → 32 | 28 → 42 | 3 → 4 | non | — |
| `#/service/commerces` | `/prestations/commerces/` | 14 → 14 | 7484 → 7311 (98 %) | 1868 → 1860 (100 %) | 30 → 32 | 25 → 39 | 3 → 4 | non | — |
| `#/service/cabinets` | `/prestations/cabinets/` | 15 → 15 | 8321 → 7892 (95 %) | 2055 → 2008 (98 %) | 31 → 33 | 33 → 47 | 3 → 4 | non | — |
| `#/service/coproprietes` | `/prestations/coproprietes/` | 14 → 14 | 7684 → 7475 (97 %) | 2010 → 1963 (98 %) | 31 → 33 | 26 → 40 | 3 → 4 | non | — |
| `#/service/meubles` | `/prestations/meubles/` | 14 → 14 | 7955 → 7680 (97 %) | 2086 → 2076 (100 %) | 30 → 32 | 26 → 40 | 3 → 4 | non | — |
| `#/service/ponctuel` | `/prestations/ponctuel/` | 14 → 14 | 7588 → 7524 (99 %) | 1950 → 1941 (100 %) | 31 → 33 | 25 → 39 | 3 → 4 | non | — |
| `#/notre-fonctionnement` | `/notre-fonctionnement/` | 5 → 5 | 4095 → 3393 (83 %) | 966 → 998 (103 %) | 9 → 11 | 15 → 28 | 2 → 3 | non | — |
| `#/departement/cote-dor` | `/zones-intervention/cote-dor/` | 11 → 11 | 6456 → 6357 (98 %) | 1376 → 1357 (99 %) | 16 → 18 | 21 → 35 | 2 → 3 | non | — |
| `#/departement/doubs` | `/zones-intervention/doubs/` | 11 → 11 | 6140 → 6049 (99 %) | 1271 → 1241 (98 %) | 14 → 16 | 21 → 35 | 2 → 3 | non | — |
| `#/departement/jura` | `/zones-intervention/jura/` | 11 → 11 | 6271 → 6138 (98 %) | 1261 → 1232 (98 %) | 15 → 17 | 21 → 35 | 2 → 3 | non | — |
| `#/departement/nievre` | `/zones-intervention/nievre/` | 11 → 11 | 6301 → 6110 (97 %) | 1284 → 1260 (98 %) | 15 → 17 | 21 → 35 | 2 → 3 | non | — |
| `#/departement/haute-saone` | `/zones-intervention/haute-saone/` | 11 → 11 | 6376 → 6166 (97 %) | 1308 → 1278 (98 %) | 15 → 17 | 21 → 35 | 2 → 3 | non | — |
| `#/departement/saone-et-loire` | `/zones-intervention/saone-et-loire/` | 11 → 11 | 6034 → 5846 (97 %) | 1222 → 1191 (97 %) | 14 → 16 | 21 → 35 | 2 → 3 | non | — |
| `#/departement/yonne` | `/zones-intervention/yonne/` | 11 → 11 | 6270 → 6138 (98 %) | 1278 → 1254 (98 %) | 15 → 17 | 21 → 35 | 2 → 3 | non | — |
| `#/departement/territoire-de-belfort` | `/zones-intervention/territoire-de-belfort/` | 11 → 11 | 6333 → 6110 (96 %) | 1310 → 1282 (98 %) | 15 → 17 | 21 → 35 | 2 → 3 | non | — |
| `#/zones-intervention` | `/zones-intervention/` | 13 → 13 | 6753 → 6188 (92 %) | 1321 → 1298 (98 %) | 12 → 14 | 20 → 33 | 2 → 3 | non | — |
| `#/contact` | `/contact/` | 4 → 4 | 1924 → 1860 (97 %) | 309 → 302 (98 %) | 1 → 6 | 15 → 28 | 3 → 3 | non | — |
| `#/bourgogne-franche-comte` | `/zones-intervention/bourgogne-franche-comte/` | 12 → 12 | 8674 → 7729 (89 %) | 1955 → 1965 (101 %) | 17 → 19 | 27 → 41 | 3 → 3 | non | — |
| `#/ville/dijon` | `/zones-intervention/cote-dor/dijon/` | 13 → 13 | 8508 → 8463 (99 %) | 1918 → 2031 (106 %) | 20 → 28 | 27 → 42 | 3 → 4 | non | — |
| `#/ville/beaune` | `/zones-intervention/cote-dor/beaune/` | 13 → 13 | 7106 → 7057 (99 %) | 1445 → 1536 (106 %) | 17 → 25 | 21 → 36 | 3 → 4 | non | — |
| `#/ville/besancon` | `/zones-intervention/doubs/besancon/` | 13 → 13 | 8076 → 8027 (99 %) | 1822 → 1927 (106 %) | 19 → 27 | 27 → 42 | 3 → 4 | non | — |
| `#/ville/dole` | `/zones-intervention/jura/dole/` | 13 → 13 | 8199 → 7985 (97 %) | 1806 → 1905 (105 %) | 20 → 28 | 27 → 42 | 3 → 4 | non | — |
| `#/ville/lons-le-saunier` | `/zones-intervention/jura/lons-le-saunier/` | 13 → 13 | 8205 → 8043 (98 %) | 1794 → 1893 (106 %) | 20 → 28 | 27 → 42 | 3 → 4 | non | — |
| `#/ville/nevers` | `/zones-intervention/nievre/nevers/` | 13 → 13 | 8077 → 8016 (99 %) | 1733 → 1841 (106 %) | 20 → 28 | 27 → 42 | 3 → 4 | non | — |
| `#/ville/vesoul` | `/zones-intervention/haute-saone/vesoul/` | 13 → 13 | 8211 → 8072 (98 %) | 1778 → 1884 (106 %) | 20 → 28 | 27 → 42 | 3 → 4 | non | — |
| `#/ville/chalon-sur-saone` | `/zones-intervention/saone-et-loire/chalon-sur-saone/` | 13 → 13 | 8062 → 8041 (100 %) | 1761 → 1860 (106 %) | 20 → 28 | 27 → 42 | 3 → 4 | non | — |
| `#/ville/macon` | `/zones-intervention/saone-et-loire/macon/` | 13 → 13 | 8072 → 7901 (98 %) | 1690 → 1789 (106 %) | 20 → 28 | 27 → 42 | 3 → 4 | non | — |
| `#/ville/auxerre` | `/zones-intervention/yonne/auxerre/` | 13 → 13 | 8089 → 8072 (100 %) | 1759 → 1867 (106 %) | 20 → 28 | 27 → 42 | 3 → 4 | non | — |
| `#/ville/belfort` | `/zones-intervention/territoire-de-belfort/belfort/` | 13 → 13 | 8098 → 8100 (100 %) | 1758 → 1862 (106 %) | 20 → 28 | 27 → 42 | 3 → 4 | non | — |
| `#/a-propos` | `/a-propos/` | 6 → 6 | 4433 → 3692 (83 %) | 1108 → 1135 (102 %) | 10 → 12 | 15 → 28 | 3 → 3 | non | — |
| `#/recrutement` | `/recrutement/` | 5 → 5 | 2394 → 2266 (95 %) | 387 → 400 (103 %) | 5 → 7 | 19 → 32 | 3 → 3 | non | — |
| `#/mentions-legales` | `/mentions-legales/` | 3 → 3 | 2014 → 2754 (137 %) | 409 → 559 (137 %) | 6 → 10 | 15 → 28 | 2 → 3 | non | — |
| `#/politique-de-confidentialite` | `/politique-de-confidentialite/` | 3 → 3 | 1936 → 2868 (148 %) | 399 → 598 (150 %) | 5 → 11 | 15 → 33 | 2 → 3 | non | — |
| `#/gestion-des-cookies` | `/gestion-des-cookies/` | 3 → 3 | 1718 → 2150 (125 %) | 345 → 479 (139 %) | 4 → 9 | 15 → 28 | 2 → 3 | non | — |
| `#/plan-du-site` | `/plan-du-site/` | 3 → 3 | 1975 → 2069 (105 %) | 315 → 335 (106 %) | 8 → 10 | 65 → 82 | 2 → 3 | non | — |
| `#/article/cout-nettoyage-bureaux` | `/conseils/cout-nettoyage-bureaux/` | 9 → 9 | 4542 → 4818 (106 %) | 839 → 800 (95 %) | 10 → 12 | 26 → 40 | 3 → 4 | non | — |
| `#/article/frequence-bureaux` | `/conseils/frequence-bureaux/` | 9 → 9 | 4437 → 4892 (110 %) | 771 → 777 (101 %) | 9 → 11 | 29 → 43 | 3 → 4 | non | — |
| `#/article/cahier-des-charges-nettoyage` | `/conseils/cahier-des-charges-nettoyage/` | 9 → 9 | 4643 → 5290 (114 %) | 741 → 766 (103 %) | 10 → 12 | 32 → 46 | 3 → 4 | non | — |
| `#/ville/saint-apollinaire` | `/zones-intervention/cote-dor/saint-apollinaire/` | 13 → 13 | 7164 → 7185 (100 %) | 1438 → 1531 (106 %) | 17 → 25 | 27 → 42 | 3 → 4 | non | — |
| `#/ville/chenove` | `/zones-intervention/cote-dor/chenove/` | 13 → 13 | 7115 → 7217 (101 %) | 1431 → 1524 (106 %) | 17 → 25 | 27 → 42 | 3 → 4 | non | — |
| `#/ville/quetigny` | `/zones-intervention/cote-dor/quetigny/` | 13 → 13 | 7031 → 6991 (99 %) | 1409 → 1502 (107 %) | 17 → 25 | 21 → 36 | 3 → 4 | non | — |
| `#/ville/talant` | `/zones-intervention/cote-dor/talant/` | 13 → 13 | 6942 → 7049 (102 %) | 1356 → 1449 (107 %) | 17 → 25 | 27 → 42 | 3 → 4 | non | — |
| `#/ville/longvic` | `/zones-intervention/cote-dor/longvic/` | 13 → 13 | 6995 → 7103 (102 %) | 1421 → 1514 (107 %) | 17 → 25 | 27 → 42 | 3 → 4 | non | — |
| `#/ville/fontaine-les-dijon` | `/zones-intervention/cote-dor/fontaine-les-dijon/` | 13 → 13 | 7322 → 7343 (100 %) | 1449 → 1542 (106 %) | 18 → 26 | 27 → 42 | 3 → 4 | non | — |
| `#/ville/marsannay-la-cote` | `/zones-intervention/cote-dor/marsannay-la-cote/` | 13 → 13 | 6993 → 6957 (99 %) | 1374 → 1467 (107 %) | 17 → 25 | 21 → 36 | 3 → 4 | non | — |
