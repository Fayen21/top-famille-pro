...
$tfp_includes = array(
	...
	'includes/cpt-zone.php',     // CPT `zone` (26 entrées, 3 niveaux via champ ACF `niveau`) + taxonomie `departement`.
	'includes/cpt-prestation.php', // CPT `prestation` (6 entrées).
	'includes/acf-fields-zone.php',       // Champs ACF structurés du CPT zone.
	'includes/acf-fields-prestation.php', // Champs ACF structurés du CPT prestation.
	'includes/acf-options-reassurance.php', // Page d'options ACF pour les avis/note réels (vide tant que non fournis, cf. docs/DONNEES-FICTIVES.md).
);
